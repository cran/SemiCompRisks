/*
 ...
 R CMD SHLIB BweibDpCorScrSM.c BweibDpCorScrSM_Updates.c BweibDpCorScrSM_Utilities.c -lgsl -lgslcblas
...
/* */
void BweibDpCorScrSMmcmc(double survData[],
                  int *n,
                  int *p1,
                  int *p2,
                  int *p3,
...

{
    ...
    for(i = 0; i < *J; i++)
    {
        gsl_vector_set(c, i, startValues[*p1 + *p2 + *p3 + *n + 9 + *J*3 + i]);
    }
    
    double tau = startValues[*p1 + *p2 + *p3 + *n + 9 + *J*3 + *J];
    ...
    double pRP1, pRP2, pRP3, pSH1, pSH2, pSH3, pSC1, pSC2, pSC3, pDP, pFP, pMP, pCP, choice;
    int move, numUpdate;
    ...
    double probSub = (1 - pDP - pSC1 - pSC2 - pSC3 -pCP - pMP)/(numUpdate-6);
    ...
    pSH2 = probSub;
    pSH3 = probSub;
    pFP  = 1-(pRP1 + pRP2 + pRP3 + pSH1 + pSH2 + pSH3 + pSC1 + pSC2 + pSC3 + pDP + pMP + pCP);
    ...
    for(MM = 0; MM < *numReps; MM++)
    {
        ...
        if(move == 1)
        {
            BweibDpCorScrSM_updateRP1(beta1, &alpha1, &kappa1, gamma, V1, survTime1, survEvent1, cluster, survCov1, accept_beta1);
        }
        ...
        if(move == 2)
        {
            BweibDpCorScrSM_updateRP2(beta2, &alpha2, &kappa2, &nu2, gamma, V2, survTime1, case01, cluster, survCov2, accept_beta2);
        }
        ...
        if(move == 3)
        {
            BweibDpCorScrSM_updateRP3(beta3, &alpha3, &kappa3, &nu3, gamma, V3, yStar, case11, cluster, survCov3, accept_beta3);
        }
        ...
        if(move == 4)
        {
            BweibDpCorScrSM_updateSC1_rw2(beta1, &alpha1, &kappa1, gamma, V1, survTime1, survEvent1, cluster, survCov1, mhProp_alpha1_var, a1, b1, &accept_alpha1);
        }
        ...
        if(move == 5)
        {
            BweibDpCorScrSM_updateSC2_rw2(beta2, &alpha2, &kappa2, &nu2, gamma, V2, survTime1, survTime2, case01, cluster, survCov2, mhProp_alpha2_var, a2, b2, &accept_alpha2);
        }
        ...
        if(move == 6)
        {
            BweibDpCorScrSM_updateSC3_rw2(beta3, &alpha3, &kappa3, &nu3, gamma, V3, yStar, case11, cluster, survCov3, mhProp_alpha3_var, a3, b3, &accept_alpha3);
        }
        ...
        if(move == 7)
        {
            BweibDpCorScrSM_updateSH1(beta1, &alpha1, &kappa1, gamma, V1, survTime1, survEvent1, cluster, survCov1, c1, d1);
        }
        ...
        if(move == 8)
        {
            BweibDpCorScrSM_updateSH2(beta2, &alpha2, &kappa2, &nu2, gamma, V2, survTime1, case01, cluster, survCov2, c2, d2);
        }
        ...
        if(move == 9)
        {
            BweibDpCorScrSM_updateSH3(beta3, &alpha3, &kappa3, &nu3, gamma, V3, yStar, case11, cluster, survCov3, c3, d3);
        }
        ...
        if(move == 10)
        {
            BweibDpCorScrSM_updateDP(gamma, &theta, mhProp_theta_var, psi, omega, &accept_theta);
        }
        ...
        if(move == 11)
        {
             ...
             BweibDpCorScrSM_updateFP_Gibbs(beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, theta, gamma, V1, V2, V3, survTime1, yStar, survEvent1, survEvent2, cluster, survCov1, survCov2, survCov3);
        ...
        if(move == 12000)
        {
            BweibDpCorScrSM_updateMP(beta2, beta3, &alpha2, &alpha3, &kappa2, &kappa3, &nu2, &nu3, gamma, V2, V3, survTime1, survTime2, case01, case11, cluster, survCov2, survCov3, &accept_nu2, &accept_nu3);
        }
        ...
        {
            /*             */
             BweibDpCorScrSM_updateCP(beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, gamma, V1, V2, V3, survTime1, yStar, survEvent1, case01, case11, cluster, survCov1, survCov2, survCov3, n_j, mu_all, Sigma_all, c, accept_V, mu0, Psi0, zeta0, rho0, tau, &nClass_DP, rr);

            
            BweibDpCorScrSM_updatePP(n, &tau, aTau, bTau, &nClass_DP);
        }
        ...
        if( ( (MM+1) % *thin ) == 0 && (MM+1) > (*numReps * *burninPerc))
        {
            ...
            BweibDpCorScrSM_logMLH(beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, theta, V1, V2, V3, survTime1, survTime2, yStar, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, &logLH);
            ...
            for(i = 0; i < *n; i++)
            {
                BweibDpCorScrSM_logMLH_i(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, theta, V1, V2, V3, survTime1, survTime2, yStar, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, &invLHval);
        ...
        if(MM == (*numReps - 1))
        {
                ...
                for(i = 0; i < *J; i++) samples_misc[*p1 + *p2 + *p3 + 7 + *n + *n + i] = (int) gsl_vector_get(accept_V, i);
            ...
            BweibDpCorScrSM_logMLH(beta1_mean, beta2_mean, beta3_mean, alpha1_mean, alpha2_mean, alpha3_mean, kappa1_mean, kappa2_mean, kappa3_mean, theta_mean, V1_mean, V2_mean, V3_mean, survTime1, survTime2, yStar, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, logLH_fin);
