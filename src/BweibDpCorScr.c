/*
 ...
 R CMD SHLIB BweibDpCorScr.c BweibDpCorScr_Updates.c BweibDpCorScr_Utilities.c -lgsl -lgslcblas
...
/* */
void BweibDpCorScrmcmc(double survData[],
                  int *n,
                  int *p1,
                  int *p2,
                  int *p3,
                       ...
                       double moveVec[])
{
    ...
    double alpha1_mean, alpha2_mean, alpha3_mean;
    double kappa1_mean, kappa2_mean, kappa3_mean;
    ...
    for(MM = 0; MM < *numReps; MM++)
    {
        ...
        if(move == 1)
        {
            BweibDpCorScr_updateRP1(beta1, &alpha1, &kappa1, gamma, V1, survTime1, survEvent1, cluster, survCov1, accept_beta1);
        }
        ...
        if(move == 2)
        {
            BweibDpCorScr_updateRP2(beta2, &alpha2, &kappa2, &nu2, gamma, V2, survTime1, case01, cluster, survCov2, accept_beta2);
        }
        ...
        if(move == 3)
        {
            BweibDpCorScr_updateRP3(beta3, &alpha3, &kappa3, &nu3, gamma, V3, survTime1, survTime2, case11, cluster, survCov3, accept_beta3);
        }
        ...
        if(move == 4)
        {
            BweibDpCorScr_updateSC1_rw2(beta1, &alpha1, &kappa1, gamma, V1, survTime1, survEvent1, cluster, survCov1, mhProp_alpha1_var, a1, b1, &accept_alpha1);
        }
        ...
        if(move == 5)
        {
            BweibDpCorScr_updateSC2_rw2(beta2, &alpha2, &kappa2, &nu2, gamma, V2, survTime1, survTime2, case01, cluster, survCov2, mhProp_alpha2_var, a2, b2, &accept_alpha2);
        }
        ...
        if(move == 6)
        {
            BweibDpCorScr_updateSC3_rw2(beta3, &alpha3, &kappa3, &nu3, gamma, V3, survTime1, survTime2, case11, cluster, survCov3, mhProp_alpha3_var, a3, b3, &accept_alpha3);
        }
        ...
        if(move == 7)
        {
            BweibDpCorScr_updateSH1(beta1, &alpha1, &kappa1, gamma, V1, survTime1, survEvent1, cluster, survCov1, c1, d1);
        }
        ...
        if(move == 8)
        {
            BweibDpCorScr_updateSH2(beta2, &alpha2, &kappa2, &nu2, gamma, V2, survTime1, case01, cluster, survCov2, c2, d2);
        }
        ...
        if(move == 9)
        {
            BweibDpCorScr_updateSH3(beta3, &alpha3, &kappa3, &nu3, gamma, V3, survTime1, survTime2, case11, cluster, survCov3, c3, d3);
        }
        ...
        if(move == 10)
        {
            BweibDpCorScr_updateDP(gamma, &theta, mhProp_theta_var, psi, omega, &accept_theta);
        }
        ...
        if(move == 11)
        {
             ...
             BweibDpCorScr_updateFP_Gibbs(beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, theta, gamma, V1, V2, V3, survTime1, survTime2, survEvent1, survEvent2, cluster, survCov1, survCov2, survCov3);
        ...
        if(move == 12000)
        {
            BweibDpCorScr_updateMP(beta2, beta3, &alpha2, &alpha3, &kappa2, &kappa3, &nu2, &nu3, gamma, V2, V3, survTime1, survTime2, case01, case11, cluster, survCov2, survCov3, &accept_nu2, &accept_nu3);
        }
        ...
        if( ( (MM+1) % *thin ) == 0 && (MM+1) > (*numReps * *burninPerc))
        {
            ...
            BweibDpCorScr_logMLH(beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, theta, V1, V2, V3, survTime1, survTime2, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, &logLH);
            ...
            for(i = 0; i < *n; i++)
            {
                BweibDpCorScr_logMLH_i(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, theta, V1, V2, V3, survTime1, survTime2, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, &invLHval);
        ...
        if(MM == (*numReps - 1))
        {
            ...
            BweibDpCorScr_logMLH(beta1_mean, beta2_mean, beta3_mean, alpha1_mean, alpha2_mean, alpha3_mean, kappa1_mean, kappa2_mean, kappa3_mean, theta_mean, V1_mean, V2_mean, V3_mean, survTime1, survTime2, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, logLH_fin);
