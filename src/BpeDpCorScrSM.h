extern void BpeDpCorScrSM_logMLH(gsl_vector *beta1,
                                 gsl_vector *beta2,
                                 gsl_vector *beta3,
                                 gsl_vector *xbeta1,
                                 gsl_vector *xbeta2,
...
extern void BpeDpCorScrSM_logMLH_i(int i,
                                   gsl_vector *beta1,
                                   gsl_vector *beta2,
                                   gsl_vector *beta3,
                                   gsl_vector *xbeta1,
...
extern void BpeDpCorScrSM_logLH(gsl_vector *beta1,
                        gsl_vector *beta2,
                        gsl_vector *beta3,
                        gsl_vector *xbeta1,
                        gsl_vector *xbeta2,
...
extern void BpeDpCorScrSM_logLH_i(int i,
                                  gsl_vector *beta1,
                                  gsl_vector *beta2,
                                  gsl_vector *beta3,
                                  gsl_vector *xbeta1,
...
extern double BpeDpCorScrSM_wFunc(int subjInx,
                                 gsl_vector *xbeta1,
                                 gsl_vector *xbeta2,
                                 gsl_vector *xbeta3,
                                 gsl_vector *lambda1,
...
extern void BpeDpCorScrSM_updateRP1(gsl_vector *beta1,
                                   gsl_vector *xbeta1,
                                   gsl_vector *gamma,
                                   gsl_vector *V1,
                                   gsl_vector *lambda1,
...
extern void BpeDpCorScrSM_updateRP2(gsl_vector *beta2,
                                   gsl_vector *xbeta2,
                                   double nu2,
                                   gsl_vector *gamma,
                                   gsl_vector *V2,
...
extern void BpeDpCorScrSM_updateRP3(gsl_vector *beta3,
                                   gsl_vector *xbeta3,
                                   double nu3,
                                   gsl_vector *gamma,
                                   gsl_vector *V3,
...
extern void BpeDpCorScrSM_updateBH1(gsl_vector *lambda1,
                                   gsl_vector *s1,
                                   gsl_vector *xbeta1,
                                   gsl_vector *gamma,
                                   gsl_vector *V1,
...
extern void BpeDpCorScrSM_updateBH2(gsl_vector *lambda2,
                                   gsl_vector *s2,
                                   gsl_vector *xbeta2,
                                   gsl_vector *gamma,
                                   gsl_vector *V2,
...
extern void BpeDpCorScrSM_updateBH3(gsl_vector *lambda3,
                                   gsl_vector *s3,
                                   gsl_vector *xbeta3,
                                   gsl_vector *gamma,
                                   gsl_vector *V3,
...
extern void BpeDpCorScrSM_updateSP1(double *mu_lam1,
                                   double *sigSq_lam1,
                                   gsl_vector *lambda1,
                                   gsl_matrix *Sigma_lam1,
                                   gsl_matrix *invSigma_lam1,
...
extern void BpeDpCorScrSM_updateSP2(double *mu_lam2,
                                   double *sigSq_lam2,
                                   gsl_vector *lambda2,
                                   gsl_matrix *Sigma_lam2,
                                   gsl_matrix *invSigma_lam2,
...
extern void BpeDpCorScrSM_updateSP3(double *mu_lam3,
                                   double *sigSq_lam3,
                                   gsl_vector *lambda3,
                                   gsl_matrix *Sigma_lam3,
                                   gsl_matrix *invSigma_lam3,
...
extern void BpeDpCorScrSM_updateFP_Gibbs(gsl_vector *gamma,
                                        double theta,
                                        gsl_vector *xbeta1,
                                        gsl_vector *xbeta2,
                                        gsl_vector *xbeta3,
...
extern void BpeDpCorScrSM_updateDP(gsl_vector *gamma,
                     double *theta,
...
extern void BpeDpCorScrSM_updateBI1(gsl_vector *s1,
                                   int *J1,
                                   int *accept_BI1,
                                   gsl_vector *survTime1,
                                   gsl_vector *survEvent1,
...
extern void BpeDpCorScrSM_updateDI1(gsl_vector *s1,
                            int *J1,
                            int *accept_DI1,
                            gsl_vector *survTime1,
                            gsl_vector *survEvent1,
...
extern void BpeDpCorScrSM_updateBI2(gsl_vector *s2,
                                   int *J2,
                                   int *accept_BI2,
                                   gsl_vector *survTime1,
                                   gsl_vector *survTime2,
...
extern void BpeDpCorScrSM_updateDI2(gsl_vector *s2,
                                   int *J2,
                                   int *accept_DI2,
                                   gsl_vector *survTime1,
                                   gsl_vector *survTime2,
...
extern void BpeDpCorScrSM_updateBI3(gsl_vector *s3,
                                   int *J3,
                                   int *accept_BI3,
                                   gsl_vector *survTime1,
                                   gsl_vector *ystar,
...
extern void BpeDpCorScrSM_updateMP(gsl_vector *beta2,
                              gsl_vector *beta3,
                              double *alpha2,
                              double *alpha3,
                              double *kappa2,
...
extern void BpeDpCorScrSM_updateCP(gsl_vector *beta1,
                                 gsl_vector *beta2,
                                 gsl_vector *beta3,
                                 gsl_vector *lambda1,
                                 gsl_vector *lambda2,
