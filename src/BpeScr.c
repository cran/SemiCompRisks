/*
 ...
 R CMD SHLIB BpeScr.c BpeScr_Updates.c BpeScr_Utilities.c -lgsl -lgslcblas
...
/* */
void BpeScrmcmc(double survData[],
                int *n,
                int *p1,
                int *p2,
                int *p3,
                ...
                double moveVec[])
{
    ...
    for(M = 0; M < *numReps; M++)
    {
        ...
        if(move == 1)
        {
            Bscr_updateRP1(beta1, xbeta1, accept_beta1, gamma, lambda1, s1, survTime1, survEvent1, survCov1, J1);
        }
        ...
        if(move == 2)
        {
            Bscr_updateRP2(beta2, xbeta2, accept_beta2, gamma, lambda2, s2, survTime1, case01, survCov2, J2);
        }
        ...
        if(move == 3)
        {
            Bscr_updateRP3(beta3, xbeta3, accept_beta3, gamma, lambda3, s3, survTime1, survTime2, case11, survCov3, J3);
        }
        ...
        if(move == 4)
        {
            Bscr_updateBH1(lambda1, s1, xbeta1, gamma, survTime1, survEvent1, Sigma_lam1, invSigma_lam1, W1, Q1, mu_lam1, sigSq_lam1, J1);
        }
        ...
        if(move == 5)
        {
            Bscr_updateBH2(lambda2, s2, xbeta2, gamma, survTime1, survTime2, case01, Sigma_lam2, invSigma_lam2, W2, Q2, mu_lam2, sigSq_lam2, J2);
        }
        ...
        if(move == 6)
        {
            Bscr_updateBH3(lambda3, s3, xbeta3, gamma, survTime1, survTime2, case11, Sigma_lam3, invSigma_lam3, W3, Q3, mu_lam3, sigSq_lam3, J3);
        }
        ...
        if(move == 7)
        {
            Bscr_updateSP1(&mu_lam1, &sigSq_lam1, lambda1, Sigma_lam1, invSigma_lam1, a1, b1, J1);
        }
        ...
        if(move == 8)
        {
            Bscr_updateSP2(&mu_lam2, &sigSq_lam2, lambda2, Sigma_lam2, invSigma_lam2, a2, b2, J2);
        }
        ...
        if(move == 9)
        {
            Bscr_updateSP3(&mu_lam3, &sigSq_lam3, lambda3, Sigma_lam3, invSigma_lam3, a3, b3, J3);
        }
        ...
        if(move == 10)
        {
            Bscr_updateFP(gamma, theta, xbeta1, xbeta2, xbeta3, lambda1, lambda2, lambda3, s1, s2, s3, J1, J2, J3, survTime1, survTime2, survEvent1, survEvent2);
        }
        ...
        if(move == 11)
        {
            Bscr_updateDP(gamma, &theta, mhProp_theta_var, psi, omega, &accept_theta);
        }
        ...
        if(move == 12)
        {
            Bscr_updateBI1(s1, &J1, &accept_BI1, survTime1, survEvent1, gamma, xbeta1, Sigma_lam1, invSigma_lam1, W1, Q1, lambda1, s_propBI1, num_s_propBI1, delPert1, alpha1, c_lam1, mu_lam1, sigSq_lam1, s1_max);
        }
        ...
        if(move == 13)
        {
            Bscr_updateBI2(s2, &J2, &accept_BI2, survTime1, survTime2, case01, gamma, xbeta2, Sigma_lam2, invSigma_lam2, W2, Q2, lambda2, s_propBI2, num_s_propBI2, delPert2, alpha2, c_lam2, mu_lam2, sigSq_lam2, s2_max);
        }
        ...
        if(move == 14)
        {
            Bscr_updateBI3(s3, &J3, &accept_BI3, survTime1, survTime2, case11, gamma, xbeta3, Sigma_lam3, invSigma_lam3, W3, Q3, lambda3, s_propBI3, num_s_propBI3, delPert3, alpha3, c_lam3, mu_lam3, sigSq_lam3, s3_max);
        }
        ...
        if(move == 15)
        {
            Bscr_updateDI1(s1, &J1, &accept_DI1, survTime1, survEvent1, gamma, xbeta1, Sigma_lam1, invSigma_lam1, W1, Q1, lambda1, s_propBI1, num_s_propBI1, delPert1, alpha1, c_lam1, mu_lam1, sigSq_lam1, s1_max, J1_max);
        }
        ...
        if(move == 16)
        {
            Bscr_updateDI2(s2, &J2, &accept_DI2, survTime1, survTime2, case01, gamma, xbeta2, Sigma_lam2, invSigma_lam2, W2, Q2, lambda2, s_propBI2, num_s_propBI2, delPert2, alpha2, c_lam2, mu_lam2, sigSq_lam2, s2_max, J2_max);
        }
        ...
        if(move == 17)
        {
            Bscr_updateDI3(s3, &J3, &accept_DI3, survTime1, survTime2, case11, gamma, xbeta3, Sigma_lam3, invSigma_lam3, W3, Q3, lambda3, s_propBI3, num_s_propBI3, delPert3, alpha3, c_lam3, mu_lam3, sigSq_lam3, s3_max, J3_max);
        }
        ...
        if( ( (M+1) % *thin ) == 0 && (M+1) > (*numReps * *burninPerc))
        {
            ...
            BpeScr_logMLH(beta1, beta2, beta3, xbeta1, xbeta2, xbeta3, theta, lambda1, lambda2, lambda3, s1, s2, s3, survTime1, survTime2, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, J1, J2, J3, &logLH);
            ...
            for(i = 0; i < *n; i++)
            {
                BpeScr_logMLH_i(i, beta1, beta2, beta3, xbeta1, xbeta2, xbeta3, theta, lambda1, lambda2, lambda3, s1, s2, s3, survTime1, survTime2, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, J1, J2, J3, &invLHval);
