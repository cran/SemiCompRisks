/*
 ...
 R CMD SHLIB BpeDpCorScr.c BpeDpCorScr_Updates.c BpeDpCorScr_Utilities.c -lgsl -lgslcblas
...
/* */
void BpeDpCorScrmcmc(double survData[],
                      int *n,
                      int *p1,
                      int *p2,
                      int *p3,
...
;
        ...
        if(move == 1)
        {
            BpeDpCorScr_updateRP1(beta1, xbeta1, gamma, V1, lambda1, s1, survTime1, survEvent1, cluster, survCov1, K1, accept_beta1);
        }
        ...
        if(move == 2)
        {
            BpeDpCorScr_updateRP2(beta2, xbeta2, nu2, gamma, V2, lambda2, s2, survTime1, case01, cluster, survCov2, K2, accept_beta2);
        }
        ...
        */
        ...
        if(move == 3)
        {
            BpeDpCorScr_updateRP3(beta3, xbeta3, nu3, gamma, V3, lambda3, s3, survTime1, survTime2, case11, cluster, survCov3, K3, accept_beta3);
        }
        ...
        if(move == 4)
        {
            BpeDpCorScr_updateBH1(lambda1, s1, xbeta1, gamma, V1, survTime1, survEvent1, cluster, Sigma_lam1, invSigma_lam1, W1, Q1, mu_lam1, sigSq_lam1, K1);
        }
        ...
        if(move == 5)
        {
            BpeDpCorScr_updateBH2(lambda2, s2, xbeta2, gamma, V2, nu2, survTime1, survTime2, case01, cluster, Sigma_lam2, invSigma_lam2, W2, Q2, mu_lam2, sigSq_lam2, K2);
        }
        ...
        if(move == 6)
        {
            BpeDpCorScr_updateBH3(lambda3, s3, xbeta3, gamma, V3, nu3, survTime1, survTime2, case11, cluster, Sigma_lam3, invSigma_lam3, W3, Q3, mu_lam3, sigSq_lam3, K3);
        }
        ...
        if(move == 7)
        {
            BpeDpCorScr_updateSP1(&mu_lam1, &sigSq_lam1, lambda1, Sigma_lam1, invSigma_lam1, a1, b1, K1);
        }
        ...
        if(move == 8)
        {
            BpeDpCorScr_updateSP2(&mu_lam2, &sigSq_lam2, lambda2, Sigma_lam2, invSigma_lam2, a2, b2, K2);
        }
        ...
        if(move == 9)
        {
            BpeDpCorScr_updateSP3(&mu_lam3, &sigSq_lam3, lambda3, Sigma_lam3, invSigma_lam3, a3, b3, K3);
        }
        ...
        if(move == 10)
        {
            ...
            BpeDpCorScr_updateFP_Gibbs(gamma, theta, xbeta1, xbeta2, xbeta3, lambda1, lambda2, lambda3, s1, s2, s3, K1, K2, K3, V1, V2, V3, survTime1, survTime2, survEvent1, survEvent2, cluster);
        }
        ...
        if(move == 11)
        {
            BpeDpCorScr_updateDP(gamma, &theta, mhProp_theta_var, psi, omega, &accept_theta);
        }
        ...
        if(move == 12)
        {
            BpeDpCorScr_updateBI1(s1, &K1, &accept_BI1, survTime1, survEvent1, gamma, xbeta1, V1, cluster, Sigma_lam1, invSigma_lam1, W1, Q1, lambda1, s_propBI1, num_s_propBI1, delPert1, alpha1, c_lam1, mu_lam1, sigSq_lam1, s1_max);
        }
        ...
        if(move == 13)
        {
            BpeDpCorScr_updateBI2(s2, &K2, &accept_BI2, survTime1, survTime2, case01, gamma, xbeta2, V2, cluster, Sigma_lam2, invSigma_lam2, W2, Q2, lambda2, s_propBI2, num_s_propBI2, delPert2, alpha2, c_lam2, mu_lam2, sigSq_lam2, s2_max);
        }
        ...
        if(move == 14)
        {
            BpeDpCorScr_updateBI3(s3, &K3, &accept_BI3, survTime1, survTime2, case11, gamma, xbeta3, V3, cluster, Sigma_lam3, invSigma_lam3, W3, Q3, lambda3, s_propBI3, num_s_propBI3, delPert3, alpha3, c_lam3, mu_lam3, sigSq_lam3, s3_max);
        }
        ...
        if(move == 15)
        {
            BpeDpCorScr_updateDI1(s1, &K1, &accept_DI1, survTime1, survEvent1, gamma, xbeta1, V1, cluster, Sigma_lam1, invSigma_lam1, W1, Q1, lambda1, s_propBI1, num_s_propBI1, delPert1, alpha1, c_lam1, mu_lam1, sigSq_lam1, s1_max, K1_max);
        }
        ...
        if(move == 16)
        {
            BpeDpCorScr_updateDI2(s2, &K2, &accept_DI2, survTime1, survTime2, case01, gamma, xbeta2, V2, cluster, Sigma_lam2, invSigma_lam2, W2, Q2, lambda2, s_propBI2, num_s_propBI2, delPert2, alpha2, c_lam2, mu_lam2, sigSq_lam2, s2_max, K2_max);
        }
        ...
        if(move == 17)
        {
            BpeDpCorScr_updateDI3(s3, &K3, &accept_DI3, survTime1, survTime2, case11, gamma, xbeta3, V3, cluster, Sigma_lam3, invSigma_lam3, W3, Q3, lambda3, s_propBI3, num_s_propBI3, delPert3, alpha3, c_lam3, mu_lam3, sigSq_lam3, s3_max, K3_max);
        }
        ...
        if( ( (MM+1) % *thin ) == 0 && (MM+1) > (*numReps * *burninPerc))
        {
            ...
            BpeDpCorScr_logMLH(beta1, beta2, beta3, xbeta1, xbeta2, xbeta3, theta, lambda1, lambda2, lambda3, s1, s2, s3, V1, V2, V3, survTime1, survTime2, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, K1, K2, K3, &logLH);
            ...
            for(i = 0; i < *n; i++)
            {
                BpeDpCorScr_logMLH_i(i, beta1, beta2, beta3, xbeta1, xbeta2, xbeta3, theta, lambda1, lambda2, lambda3, s1, s2, s3, V1, V2, V3, survTime1, survTime2, survEvent1, survEvent2, case01, case11, survCov1, survCov2, survCov3, cluster, K1, K2, K3, &invLHval);
