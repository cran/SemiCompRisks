...
void BpeDpCorScr_updateRP1(gsl_vector *beta1,
                            gsl_vector *xbeta1,
                            gsl_vector *gamma,
                            gsl_vector *V1,
                            gsl_vector *lambda1,
...
void BpeDpCorScr_updateRP2(gsl_vector *beta2,
                            gsl_vector *xbeta2,
                            double nu2,                            
                            gsl_vector *gamma,
                            gsl_vector *V2,
...
void BpeDpCorScr_updateRP3(gsl_vector *beta3,
                            gsl_vector *xbeta3,
                            double nu3,
                            gsl_vector *gamma,
                            gsl_vector *V3,
...
void BpeDpCorScr_updateBH1(gsl_vector *lambda1,
                            gsl_vector *s1,
                            gsl_vector *xbeta1,
                            gsl_vector *gamma,
                            gsl_vector *V1,
...
void BpeDpCorScr_updateBH2(gsl_vector *lambda2,
                            gsl_vector *s2,
                            gsl_vector *xbeta2,
                            gsl_vector *gamma,
                            gsl_vector *V2,
...
void BpeDpCorScr_updateBH3(gsl_vector *lambda3,
                            gsl_vector *s3,
                            gsl_vector *xbeta3,
                            gsl_vector *gamma,
                            gsl_vector *V3,
...
void BpeDpCorScr_updateSP1(double *mu_lam1,
                    double *sigSq_lam1,
                    gsl_vector *lambda1,
                    gsl_matrix *Sigma_lam1,
                    gsl_matrix *invSigma_lam1,
...
void BpeDpCorScr_updateSP2(double *mu_lam2,
                    double *sigSq_lam2,
                    gsl_vector *lambda2,
                    gsl_matrix *Sigma_lam2,
                    gsl_matrix *invSigma_lam2,
...
void BpeDpCorScr_updateSP3(double *mu_lam3,
                    double *sigSq_lam3,
                    gsl_vector *lambda3,
                    gsl_matrix *Sigma_lam3,
                    gsl_matrix *invSigma_lam3,
...
void BpeDpCorScr_updateFP_Gibbs(gsl_vector *gamma,
                                 double theta,
                                 gsl_vector *xbeta1,
                                 gsl_vector *xbeta2,
                                 gsl_vector *xbeta3,
                                 ...
                                 gsl_vector *cluster)
{
    ...
    for(i = 0; i< n; i++)
    {
        ...
        gamma_rate  = BpeDpCorScr_wFunc(i, xbeta1, xbeta2, xbeta3, lambda1, lambda2, lambda3, jj, V1, V2, V3, s1, s2, s3, J1, J2, J3, survTime1, survTime2) + 1/theta;
...
void BpeDpCorScr_updateDP(gsl_vector *gamma,
              double *theta,
...
void BpeDpCorScr_updateBI1(gsl_vector *s1,
                            int *J1,
                            int *accept_BI1,
                            gsl_vector *survTime1,
                            gsl_vector *survEvent1,
...
void BpeDpCorScr_updateDI1(gsl_vector *s1,
                    int *J1,
                    int *accept_DI1,
                    gsl_vector *survTime1,
                    gsl_vector *survEvent1,
...
void BpeDpCorScr_updateBI2(gsl_vector *s2,
                    int *J2,
                    int *accept_BI2,
                    gsl_vector *survTime1,
                    gsl_vector *survTime2,
...
void BpeDpCorScr_updateDI2(gsl_vector *s2,
                    int *J2,
                    int *accept_DI2,
                    gsl_vector *survTime1,
                    gsl_vector *survTime2,
...
void BpeDpCorScr_updateBI3(gsl_vector *s3,
                    int *J3,
                    int *accept_BI3,
                    gsl_vector *survTime1,
                    gsl_vector *survTime2,
...
void BpeDpCorScr_updateMP(gsl_vector *beta2,
                       gsl_vector *beta3,
                       double *alpha2,
                       double *alpha3,
                       double *kappa2,
...
void BpeDpCorScr_updateCP(gsl_vector *beta1,
                            gsl_vector *beta2,
                            gsl_vector *beta3,
                            gsl_vector *lambda1,
                            gsl_vector *lambda2,
...
void BpeDpCorScr_updatePP(int *n,
                            double *tau,
                            double aTau,
                            double bTau,
                            int *nClass_DP)
