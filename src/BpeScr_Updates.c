...
void Bscr_updateRP1(gsl_vector *beta1,
               gsl_vector *xbeta1,
...
void Bscr_updateRP2(gsl_vector *beta2,
               gsl_vector *xbeta2,
...
void Bscr_updateRP3(gsl_vector *beta3,
               gsl_vector *xbeta3,
...
void Bscr_updateBH1(gsl_vector *lambda1,
               gsl_vector *s1,
               gsl_vector *xbeta1,
               gsl_vector *gamma,               
               gsl_vector *survTime1,
...
void Bscr_updateBH2(gsl_vector *lambda2,
               gsl_vector *s2,
               gsl_vector *xbeta2,
               gsl_vector *gamma,
               gsl_vector *survTime1,
...
void Bscr_updateBH3(gsl_vector *lambda3,
               gsl_vector *s3,
               gsl_vector *xbeta3,
               gsl_vector *gamma,
               gsl_vector *survTime1,
...
void Bscr_updateSP1(double *mu_lam1,
               double *sigSq_lam1,
               gsl_vector *lambda1,
               gsl_matrix *Sigma_lam1,
               gsl_matrix *invSigma_lam1,
...
void Bscr_updateSP2(double *mu_lam2,
               double *sigSq_lam2,
               gsl_vector *lambda2,
               gsl_matrix *Sigma_lam2,
               gsl_matrix *invSigma_lam2,
...
void Bscr_updateSP3(double *mu_lam3,
               double *sigSq_lam3,
               gsl_vector *lambda3,
               gsl_matrix *Sigma_lam3,
               gsl_matrix *invSigma_lam3,
...
void Bscr_updateFP(gsl_vector *gamma,
              double theta,
              gsl_vector *xbeta1,
              gsl_vector *xbeta2,
              gsl_vector *xbeta3,
              ...
              gsl_vector *survEvent2)
{
    ...
    for(i = 0; i< n; i++)
    {
        ...
        gamma_rate  = Bscr_wFunc(i, xbeta1, xbeta2, xbeta3, lambda1, lambda2, lambda3, s1, s2, s3, J1, J2, J3, survTime1, survTime2) + 1/theta;
        ...
        /*
    printf("gamma_shape = %.3f\n", gamma_shape);
    printf("gamma_rate = %.3f\n", gamma_rate);
*/
    return;
}
...
void Bscr_updateDP(gsl_vector *gamma,
              double *theta,
...
void Bscr_updateBI1(gsl_vector *s1,
               int *J1,
               int *accept_BI1,
               gsl_vector *survTime1,
               gsl_vector *survEvent1,
        ...
        for(i = 0; i < n; i++)
        {
            if(gsl_vector_get(survEvent1, i) == 1)
            {
                if(j == 0 && gsl_vector_get(survTime1, i) <= gsl_vector_get(s_new, 0))
                {
                    ...
                    /*
                    loglh1 += gsl_vector_get(lambda_new, j);
                     */
                }
            ...
            if(Del > 0)
            {
                ...
                /*
               loglh2   += - gsl_vector_get(gamma, i) * Del*exp(gsl_vector_get(lambda_new, j))*exp(gsl_vector_get(xbeta1, i));
                 */
            }
        }
    }
...
void Bscr_updateDI1(gsl_vector *s1,
               int *J1,
               int *accept_DI1,
               gsl_vector *survTime1,
               gsl_vector *survEvent1,
               ...
               int J1_max)
{
    ...
    if(*J1+1 != 2)
    {
        ...
        /*
        printf("logPriorDen = %.3f\n", logPrior);
        printf("logPriorDen_prop = %.3f\n", logPrior_prop);
        */
...
void Bscr_updateBI2(gsl_vector *s2,
               int *J2,
               int *accept_BI2,
               gsl_vector *survTime1,
               gsl_vector *survTime2,
...
void Bscr_updateDI2(gsl_vector *s2,
               int *J2,
               int *accept_DI2,
               gsl_vector *survTime1,
               gsl_vector *survTime2,
...
void Bscr_updateBI3(gsl_vector *s3,
               int *J3,
               int *accept_BI3,
               gsl_vector *survTime1,
               gsl_vector *survTime2,
...
void Bscr_updateDI3(gsl_vector *s3,
               int *J3,
               int *accept_DI3,
               gsl_vector *survTime1,
               gsl_vector *survTime2,
