...
void BweibDpCorScrSM_updateRP1(gsl_vector *beta1,
                              double *alpha1,
                              double *kappa1,
                              gsl_vector *gamma,
                              gsl_vector *V1,
...
void BweibDpCorScrSM_updateRP2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateRP3(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateSC1(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibDpCorScrSM_updateSC1_rw2(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibDpCorScrSM_updateSC1_amc(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibDpCorScrSM_updateSC2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateSC2_rw2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateSC3(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateSC3_rw2(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateSH1(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibDpCorScrSM_updateSH2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateSH3(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibDpCorScrSM_updateDP(gsl_vector *gamma,
              double *theta,
...
void BweibDpCorScrSM_updateFP_Gibbs(gsl_vector *beta1,
                             gsl_vector *beta2,
                             gsl_vector *beta3,
                             double alpha1,
                             double alpha2,
                             ...
                             gsl_matrix *survCov3)
{
    ...
    for(i = 0; i< n; i++)
    {
        ...
        gamma_rate  = BweibDpCorScrSM_wFunc_old(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, V1, V2, V3, survTime1, yStar, cluster, survCov1, survCov2, survCov3) + 1/theta;
...
void BweibDpCorScrSM_updateMP(gsl_vector *beta2,
                       gsl_vector *beta3,
                       double *alpha2,
                       double *alpha3,
                       double *kappa2,
...
void BweibDpCorScrSM_updateFP(gsl_vector *beta1,
                       gsl_vector *beta2,
                       gsl_vector *beta3,
                       double alpha1,
                       double alpha2,
    ...
    for(i = 0; i < n; i++)
    {
        if(gsl_vector_get(mhGam_chk, i) == 0)
        {
            ...
            else
            {
                ...
                logLH += -BweibDpCorScrSM_wFunc(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, nu2, nu3, gam, V1, V2, V3, survTime1, survTime2, cluster, survCov1, survCov2, survCov3);
                logLH_prop += -BweibDpCorScrSM_wFunc(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, nu2, nu3, temp_prop, V1, V2, V3, survTime1, survTime2, cluster, survCov1, survCov2, survCov3);
...
void BweibDpCorScrSM_updateCP(gsl_vector *beta1,
                            gsl_vector *beta2,
                            gsl_vector *beta3,
                            double alpha1,
                            double alpha2,
    ...
    *nClass_DP = u;
    ...
    for(j = 0; j < J; j++)
    {
        ...
        for(i = startInx; i < endInx; i++)
        {
            ...
            term = -gsl_vector_get(gamma, i) * (kappa1 * pow(gsl_vector_get(survTime1, i), alpha1) * exp(LP1 + gsl_vector_get(V1, j)) + kappa2 * pow(gsl_vector_get(survTime1, i), alpha2) * exp(LP2 + gsl_vector_get(V2, j)) + kappa3 * pow(gsl_vector_get(yStar, i), alpha3) * exp(LP3 + gsl_vector_get(V3, j)));
            logLH +=  term;
        ...
        for(i = startInx; i < endInx; i++)
        {
            ...
            term = -gsl_vector_get(gamma, i) * (kappa1 * pow(gsl_vector_get(survTime1, i), alpha1) * exp(LP1 + gsl_vector_get(V_prop, 0)) + kappa2 * pow(gsl_vector_get(survTime1, i), alpha2) * exp(LP2 + gsl_vector_get(V_prop, 1)) + kappa3 * pow(gsl_vector_get(yStar, i), alpha3) * exp(LP3 + gsl_vector_get(V_prop, 2)));
            logLH_prop +=  term;
...
void BweibDpCorScrSM_updatePP(int *n,
                            double *tau,
                            double aTau,
                            double bTau,
                            int *nClass_DP)
