...
void BweibMvnCorScr_updateRP1(gsl_vector *beta1,
                           double *alpha1,
                           double *kappa1,
                           gsl_vector *gamma,
                           gsl_vector *V1,
...
void BweibMvnCorScr_updateRP2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateRP3(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateSC1(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibMvnCorScr_updateSC1_rw2(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibMvnCorScr_updateSC1_amc(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibMvnCorScr_updateSC2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateSC2_rw2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateSC3(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateSC3_rw2(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateSH1(gsl_vector *beta1,
                        double *alpha1,
                        double *kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibMvnCorScr_updateSH2(gsl_vector *beta2,
                        double *alpha2,
                        double *kappa2,
                        double *nu2,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateSH3(gsl_vector *beta3,
                        double *alpha3,
                        double *kappa3,
                        double *nu3,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateDP(gsl_vector *gamma,
              double *theta,
...
void BweibMvnCorScr_updateFP_Gibbs(gsl_vector *beta1,
                             gsl_vector *beta2,
                             gsl_vector *beta3,
                             double alpha1,
                             double alpha2,
                             ...
                             gsl_matrix *survCov3)
{
    ...
    for(i = 0; i< n; i++)
    {
        ...
        gamma_rate  = BweibMvnCorScr_wFunc_old(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, V1, V2, V3, survTime1, survTime2, cluster, survCov1, survCov2, survCov3) + 1/theta;
...
void BweibMvnCorScr_updateMP(gsl_vector *beta2,
                       gsl_vector *beta3,
                       double *alpha2,
                       double *alpha3,
                       double *kappa2,
...
void BweibMvnCorScr_updateFP(gsl_vector *beta1,
                       gsl_vector *beta2,
                       gsl_vector *beta3,
                       double alpha1,
                       double alpha2,
    ...
    for(i = 0; i < n; i++)
    {
        if(gsl_vector_get(mhGam_chk, i) == 0)
        {
            ...
            else
            {
                ...
                logLH += -BweibMvnCorScr_wFunc(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, nu2, nu3, gam, V1, V2, V3, survTime1, survTime2, cluster, survCov1, survCov2, survCov3);
                logLH_prop += -BweibMvnCorScr_wFunc(i, beta1, beta2, beta3, alpha1, alpha2, alpha3, kappa1, kappa2, kappa3, nu2, nu3, temp_prop, V1, V2, V3, survTime1, survTime2, cluster, survCov1, survCov2, survCov3);
...
void BweibMvnCorScr_updateCP1(gsl_vector *beta1,
                        double alpha1,
                        double kappa1,
                        gsl_vector *gamma,
                        gsl_vector *V1,
...
void BweibMvnCorScr_updateCP1_amcmc(gsl_vector *beta1,
                                    double alpha1,
                                    double kappa1,
                                    gsl_vector *gamma,
                                    gsl_vector *V1,
...
void BweibMvnCorScr_updateCP2(gsl_vector *beta2,
                        double alpha2,
                        double kappa2,
                        double nu2,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateCP2_amcmc(gsl_vector *beta2,
                        double alpha2,
                        double kappa2,
                        double nu2,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateCP3(gsl_vector *beta3,
                        double alpha3,
                        double kappa3,
                        double nu3,
                        gsl_vector *gamma,
...
void BweibMvnCorScr_updateCP3_amcmc(gsl_vector *beta3,
                        double alpha3,
                        double kappa3,
                        double nu3,
                        gsl_vector *gamma,
                        ...
                        double mhProp_V3_var)
{
    ...
    for(j = 0; j < J; j++)
    {
        ...
        for(i = startInx; i < endInx; i++)
        {
            ...
            term = -pow(gsl_vector_get(gamma, i), nu3) * (kappa3) * (pow(gsl_vector_get(survTime2, i), alpha3)-pow(gsl_vector_get(survTime1, i), alpha3)) * exp(LP + gsl_vector_get(V3, j));
            logLH +=  term;
            D1 += term;
            D2 += term;
        }
        ...
        for(i = startInx; i < endInx; i++)
        {
            ...
            term = -pow(gsl_vector_get(gamma, i), nu3) * (kappa3) * (pow(gsl_vector_get(survTime2, i), alpha3)-pow(gsl_vector_get(survTime1, i), alpha3)) * exp(LP + temp_prop);
            logLH_prop +=  term;
            D1_prop += term;
            D2_prop += term;
        }
...
void BweibMvnCorScr_updateVP(gsl_vector *V1,
                             gsl_vector *V2,
                             gsl_vector *V3,
                             gsl_matrix *Sigma_V,
                             double rho_v,
